...
import { IUploadDocumentsModalEditState } from '../Models/IUploadDocumentsModalEditState';



export class ModalEditUploadDocuments extends React.Component<{}, IUploadDocumentsModalEditState> {
    public state: IUploadDocumentsModalEditState = {
        showModal: false,
        key: "",
        name: "",
        value: "",
